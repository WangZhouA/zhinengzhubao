...
public class ReigstActivity extends BaseActivity implements View.OnClickListener {
...
//    android:textColor="#FF61B4"
    ...
    private void okokHttpReigst() {
        ...
        final String reigstStr = StringUtils.Reigst+reigst_code.getText().toString();
