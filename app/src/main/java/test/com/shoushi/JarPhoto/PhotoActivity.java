...
public class PhotoActivity extends Activity {
	...
	private void initListViews_WangZhou(String path) {
		if (listViews == null)
			listViews = new ArrayList<View>();
		ImageView img = new ImageView(this);// 构造textView对象
		img.setBackgroundColor(0xff000000);

		StringUtils.showImage(PhotoActivity.this,StringUtils.HTTP_SERVICE+path,R.mipmap.img_yonghumr,R.mipmap.img_yonghumr,img);
